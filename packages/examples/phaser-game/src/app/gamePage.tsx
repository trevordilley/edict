...
const {insert, rule, fire, retract } = edict<{
  ...
  rule("Circles with a destination move to destination", ({circle, speed, dt, destX, destY}) => (
    {
  ...
  rule("When a new destination is set, add the destination to the circles", ({circle, destX, destY}) => (
    {
        $npc: {circle},
  ...
  rule("Arriving at their destination stops them", ({ circle, destX, destY}) => ({
